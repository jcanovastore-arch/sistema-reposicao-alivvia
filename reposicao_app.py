...
if st.session_state.catalogo_df is None: 
    # 🛑 Alerta crítico movido para o topo
    st.warning("⚠️ Carregue o Padrão de Produtos no menu lateral para que o Mapeamento de SKU e o Cálculo de Kits funcionem.")
